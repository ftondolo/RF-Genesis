...
# Get both PIRs and depth camera pointclouds from pathtracer
...
# Pass depth camera pointclouds (body_aux) instead of a PLY file path
visualize.save_video(
    "models/TI1843_config.json", 
    os.path.join(output_dir, 'radar_frames.npy'),
    body_aux,  # Pass the depth camera pointclouds
