...
class RayTracer:
    ...
    def get_depth_pointcloud(self):
        ...
        # Use the depth sensor (second sensor in the scene)
        depth_sensor = self.scene.sensors()[1]
...
def get_deafult_scene(res = 512, depth_res = 256):
    ...
    default_scene ={
            ...
            'sensor': sensor,
            'depth_sensor': depth_sensor,  # Add depth sensor for visualization
            ...
            'smpl':{
                ...
                'to_world' : T.translate([0, 0, 0]).scale(0.2),
                "mybsdf": {
                    "type": "ref",
                    "id": "while"
                },
